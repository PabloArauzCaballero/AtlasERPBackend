...
| ------------------------------------------------------------------------ | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| No se puede ejecutar PostgreSQL real dentro del sandbox                  | No se confirma smoke e2e real contra base de datos en esta auditoría | Ejecutar `yarn db:migrate`, `yarn db:seed:pull` y `yarn smoke:ads` en staging                    |
