...
| ------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| No se ejecutó smoke e2e contra PostgreSQL real dentro del sandbox                                | No confirma migración/queries en una instancia real durante esta auditoría   | Ejecutar `yarn db:migrate && yarn db:seed:pull && yarn smoke:ads` en staging con PostgreSQL           |
