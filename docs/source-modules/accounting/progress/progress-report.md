...
| El smoke ejecutado en este entorno no tuvo API/PostgreSQL corriendo                         | El resultado JSON demuestra persistencia del smoke, pero no éxito funcional de endpoints                                                           | Ejecutar `yarn db:migrate`, levantar API y correr `yarn smoke:accounting` en local/CI                                          |
